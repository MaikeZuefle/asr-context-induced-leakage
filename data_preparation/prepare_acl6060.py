...
from data.acl6060 import load_asr
...
def main(out_path: str, max_distance: int, gemma_model_path: str):
    ...
    with open(out_path, "a", encoding="utf-8") as f_out:
        for audio_path, reference in tqdm(
            zip(audio_paths, references), total=len(audio_paths), desc="Preparing ACL6060"
        ):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_path", default="data/prepared/acl6060.jsonl")
    ...
    main(args.out_path, args.max_distance, args.gemma_model_path)
