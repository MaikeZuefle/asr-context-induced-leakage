...
# Fine-tuned models
FT_MODELS=( "context_word" "target_word" "both" "fleurs_context_1" "fleurs_context_5" "fleurs_context_10" "fleurs_context_mixed" "context_word_fleurs_mixed" "target_word_fleurs_mixed" "both_fleurs_mixed" )
